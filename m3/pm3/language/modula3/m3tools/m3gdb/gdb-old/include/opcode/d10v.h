...
/* f0 / f1 flag register */
#define OPERAND_FFLAG	(0x800)

/* c flag register */
#define OPERAND_CFLAG	(0x1000)

/* control register  */
#define OPERAND_CONTROL	(0x2000)

/* predecrement mode '@-sp'  */
#define OPERAND_ATMINUS	(0x4000)

/* signed number */
#define OPERAND_SIGNED	(0x8000)

/* special accumulator shifts need a 4-bit number */
/* 1 <= x <= 16 */
#define OPERAND_SHIFT	(0x10000)
