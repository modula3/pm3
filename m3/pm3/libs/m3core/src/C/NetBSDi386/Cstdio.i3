...
<*EXTERNAL nbsd_feof*>      PROCEDURE feof (f: FILE_star): int;
<*EXTERNAL nbsd_getc*>      PROCEDURE getc (f: FILE_star): int;
<*EXTERNAL nbsd_ungetc*>    PROCEDURE ungetc (c: int; f: FILE_star): int;
<*EXTERNAL nbsd_putc*>      PROCEDURE putc (c: int; f: FILE_star): int;
<*EXTERNAL nbsd_fflush*>    PROCEDURE fflush (f: FILE_star): int;
<*EXTERNAL nbsd_fdopen*>    PROCEDURE fdopen (fd: int; mode: char_star): FILE_star;
<*EXTERNAL nbsd_fclose*>    PROCEDURE fclose (f: FILE_star): int;
