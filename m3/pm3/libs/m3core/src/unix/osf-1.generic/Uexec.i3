...
(* Last modified on Tue Aug  3 10:11:37 PDT 1993 by kalsow         *)
...
IMPORT Ctypes, Uresource, Utypes;
...
(* options bits for wait3 and waitpid. *)
CONST
...
<*EXTERNAL*> 
PROCEDURE wait (status: Ctypes.int_star): Utypes.pid_t;

<*EXTERNAL*>
PROCEDURE wait3 (status  : w_A_star;
                 options : Ctypes.int;
                 rusage  : Uresource.struct_rusage_star): Utypes.pid_t;

<*EXTERNAL*>
PROCEDURE waitpid (pid     : Utypes.pid_t;
                   status  : w_A_star; 
