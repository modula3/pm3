...
(** $Author$
    ...
    Revision 1.1  1997/07/07 15:43:40  roland
...
CONST Brand = "SourceCacheStorage";

(* Keys are (node number, label) pairs, values are sets of source nodes. *)
