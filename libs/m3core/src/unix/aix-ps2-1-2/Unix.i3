...
(* Last modified on Wed Aug 17 15:49:52 PDT 1994 by kalsow                   *)
(*      modified on Tue Jun  8 16:26:06 PDT 1993 by mcjones                  *)
(*      modified on Thu Nov 12 12:39:31 PST 1992 by muller                   *)
...
CONST
  ...
  FNDELAY =    8_000104;        (* no delay *)
  FAPPEND =    8_000010;        (* append on each write *)
  FMARK =      8_004000;        (* makr during gc() *)
  FDEFER =     8_010000;        (* fefer for next gc pass *)
  FASYNC =     8_000020;        (* signal pgrp when data ready *)
  FCREAT =     8_000400;        (* create if nonexistant *)
  FTRUNC  =    8_001000;        (* truncate to zero length *)
  FEXCL =      8_002000;        (* error if already created *)
  FSYNCRON =   8_200000;        (* write file syncronously *)
  FNBLOCK =    8_000104;        (* POSIX no delay *)
...
CONST   (* request *)
  ...
  F_OPENLOCK = 8; (* Dos - file sharing options *)
  F_GETOWN = 9;   (* Get owner *)
  F_SETOWN = 10;   (* Set owner *)
...
<*EXTERNAL*> PROCEDURE mount (special, name: char_star; mflag: int): int;

<*EXTERNAL*> PROCEDURE umount (dev: char_star; flag: int): int;
...
<*EXTERNAL*> PROCEDURE reboot (howto: int);
...
(* In the BSD C world of AIX PS/2 1.2, the constant FD_SETSIZE is 200
   and sizeof (fd_set) = 28. Just to that Modula-3 does the right thing, 
   we take the larger of 28*8 and 200 *)
