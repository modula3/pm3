...
(** $Author$
    ...
    Revision 1.1  1997/03/26 11:38:52  roland
    ...
    Revision 1.3  1996/08/06 16:26:20  roland
    Merge of PAGESERVER and main branch.

# Revision 1.2  1994/03/30  18:30:31  pk
# New shape for 3.1 required.
#
# Revision 1.1  1994/01/20  18:41:10  pk
# Initial revision
#
*)
(***************************************************************************)
...
PROCEDURE Equal (READONLY a, b: T): BOOLEAN =
  BEGIN
    RETURN ((a.number = b.number) AND Text.Equal(a.value, b.value));
  END Equal;
