...
(*                                                                           *)
(* Last modified on Fri Oct  8 14:00:43 PDT 1993 by steveg *)
(*      modified on Mon Jun 14 20:42:03 PDT 1993 by meehan *)
(*      modified on Tue Feb  2 00:34:27 PST 1993 by mhb    *)
...
(* The call to "v.init(..)" initializes "v" as a "ViewportVBT.T".  The
   ...
   collection of "JoinedVBT"s, "HVSplit"s, "ScrollerVBT"s, and
...
(* The styles are as follows:
   ...
   <LI>"HorAndVer" puts a horizontal and vertical scrollbar
   ...
   <LI>"AlaViewport" specifies that there is a scrollbar in the
   same axis as the viewport.  Thus, "AlaViewport" for a vertical
   viewport is equivalent to "VerOnly".

   <LI>"Auto" specifies that scrollbars appear only when the
